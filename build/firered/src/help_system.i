...
void SetHelpContextForMap(void)
{
    ...
    {
        if (((gSaveBlock1Ptr->location.mapGroup == ((0 | (4 << 8)) >> 8) && gSaveBlock1Ptr->location.mapNum == ((0 | (4 << 8)) & 0xFF)) || (gSaveBlock1Ptr->location.mapGroup == ((1 | (4 << 8)) >> 8) && gSaveBlock1Ptr->location.mapNum == ((1 | (4 << 8)) & 0xFF))))
            SetHelpContext(14);
        else if ((gSaveBlock1Ptr->location.mapGroup == ((3 | (4 << 8)) >> 8) && gSaveBlock1Ptr->location.mapNum == ((3 | (4 << 8)) & 0xFF)))
            SetHelpContext(15);
