...
static const struct GFRomHeader sGFRomHeader = {
    ...
    .pokedexFlag = ((((0x500 + 1) + 768 - 1) + 1) + 0x38),
    .mysteryGiftFlag = ((((0x500 + 1) + 768 - 1) + 1) + 0x39),
    .pokedexCount = NATIONAL_DEX_LITTEN,
    .playerNameLength = 7,
    .unk2 = 10,
    ...
    .gameClearFlag = ((((0x500 + 1) + 768 - 1) + 1) + 0x2C),
    .ribbonFlag = ((((0x500 + 1) + 768 - 1) + 1) + 0x3B),
    .bagCountItems = 42,
    .bagCountKeyItems = 30,
