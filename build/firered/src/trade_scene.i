...
struct {
             ...
             u16 cachedMapMusic;
             u8 unk_F6;
             struct QuestLogEvent_Traded questLogData;
              u8 textColor[3];
              u8 filler_107[1];
              bool8 isCableTrade;
              u8 win0left;
...
void CB2_LinkTrade(void)
{
    ...
    case 10:
        ...
        ShowBg(0);
        sTradeAnim->questLogData.speciesSent = GetMonData(&gPlayerParty[gSelectedTradeMonPositions[0]], 65);
        sTradeAnim->questLogData.speciesReceived = GetMonData(&gEnemyParty[gSelectedTradeMonPositions[1] % 6], 65);
        memcpy(sTradeAnim->questLogData.partnerName, gLinkPlayers[GetMultiplayerId() ^ 1].name, 7);
        gMain.state++;
        break;
    case 11:
...
static bool8 DoTradeAnim_Cable(void)
{
    ...
    case STATE_SEND_MSG:
        ...
        if (sTradeAnim->monSpecies[0] != 413)
    ...
    case STATE_DELAY_FOR_MON_ANIM:
        if (++sTradeAnim->timer > 60)
        {
            if (sTradeAnim->monSpecies[1] != 413)
...
static void CB2_SaveAndEndTrade(void)
{
    ...
    case 50:
        if (InUnionRoom())
        {
            SetQuestLogEvent(18, (void *)&sTradeAnim->questLogData);
        }
        else
        {
            SetQuestLogEvent(12, (void *)&sTradeAnim->questLogData);
